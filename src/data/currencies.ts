...
export const currencies: ICurrency[] = [
  ...
  { name: 'Bangladeshi taka', abbrev: 'BDT' },
  ...
  { name: 'Czech Republic Koruna', abbrev: 'CZK' },
  { name: 'Denmark Krone', abbrev: 'DKK' },
  { name: 'Dominican Republic Peso', abbrev: 'DOP' },
  ...
  { name: 'Isle of Man Pound', abbrev: 'IMP' },
  { name: 'Israel Shekel', abbrev: 'ILS' },
  { name: 'Jamaica Dollar', abbrev: 'JMD' },
  { name: 'Japan Yen', abbrev: 'JPY' },
  { name: 'Jersey Pound', abbrev: 'JEP' },
  { name: 'Kazakhstan Tenge', abbrev: 'KZT' },
  { name: 'Korea (North) Won', abbrev: 'KPW' },
  { name: 'Korea (South) Won', abbrev: 'KRW' },
  ...
  { name: 'Mongolia Tughrik', abbrev: 'MNT' },
  { name: 'Mozambique Metical', abbrev: 'MZN' },
  { name: 'Namibia Dollar', abbrev: 'NAD' },
  { name: 'Nepal Rupee', abbrev: 'NPR' },
  { name: 'Netherlands Antilles Guilder', abbrev: 'ANG' },
  { name: 'New Zealand Dollar', abbrev: 'NZD' },
  { name: 'Nicaragua Cordoba', abbrev: 'NIO' },
  { name: 'Norway Krone', abbrev: 'NOK' },
  ...
  { name: 'Qatar Riyal', abbrev: 'QAR' },
  { name: 'Romania New Leu', abbrev: 'RON' },
  { name: 'Russia Ruble', abbrev: 'RUB' },
  { name: 'Saint Helena Pound', abbrev: 'SHP' },
  ...
  { name: 'Somalia Shilling', abbrev: 'SOS' },
  ...
  { name: 'Taiwan New Dollar', abbrev: 'TWD' },
  { name: 'Thailand Baht', abbrev: 'THB' },
  { name: 'Trinidad and Tobago Dollar', abbrev: 'TTD' },
  { name: 'Turkey Lira', abbrev: 'TRY' },
  { name: 'Turkey Lira', abbrev: 'TRL' },
  { name: 'Tuvalu Dollar', abbrev: 'TVD' },
  { name: 'Ukraine Hryvna', abbrev: 'UAH' },
  { name: 'United Kingdom Pound', abbrev: 'GBP' },
  { name: 'Uganda Shilling', abbrev: 'UGX' },
  { name: 'United States Dollar', abbrev: 'USD' },
  { name: 'Uruguay Peso', abbrev: 'UYU' },
  { name: 'Uzbekistan Som', abbrev: 'UZS' },
  { name: 'Venezuela Bolivar', abbrev: 'VEF' },
  { name: 'Viet Nam Dong', abbrev: 'VND' },
